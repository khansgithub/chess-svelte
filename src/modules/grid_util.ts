...
export class MustBe {
    /**
     * Throw an error if this object is not an instance of `that_type`
     * @param that_type typeof <obj> or Class
     * @returns this
     */
    mustBe(that_type: any): typeof this {
        if (this instanceof that_type) return this;
        throw new Error(`Object is not of ${that_type}`);
    };
}
